...
(function dartProgram() {
  ...
  K = {
    main: function() {
      var _i, data, len, t1, type, number,
        weight = ["25kg", "30lb", "56lb", "14kg", "68lb", "198kg"];
      for (_i = 0; _i < 6; ++_i) {
        data = weight[_i];
        len = data.length;
        t1 = len - 2;
        ...
        type = data[t1];
        number = P.int_parse(C.JSString_methods.substring$2(data, 0, t1));
        if (type === "kg") {
          t1 = " " + H.S(number) + " \u516c\u65a4 =  ";
          if (typeof number !== "number")
            return number.$mul();
          H.printString(t1 + H.S(number * 2.2) + " \u78c5");
        } else {
          t1 = " " + H.S(number) + " \u78c5 =  ";
          if (typeof number !== "number")
            return number.$mul();
          H.printString(t1 + H.S(number * 0.454) + " \u516c\u65a4");
        }
      }
    }
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, H.Closure, P.Error, P.bool, P.num, P.FormatException, P.List, P.Null, P.String, P.StringBuffer]);
...
//# sourceMappingURL=kglb_dart.js.map
