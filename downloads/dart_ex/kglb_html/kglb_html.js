...
(function dartProgram() {
  ...
  Q = {
    main: function() {
      var t2,
        t1 = document,
        tempInput = H.interceptedTypeCheck(t1.querySelector("#temp"), "$isInputElement");
      t1 = J.get$onClick$x(t1.querySelector("#submit"));
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new Q.main_closure(tempInput), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    ...
    call$1: function(e) {
      ...
      if (t1 || t1) {
        ...
        if (typeof number !== "number")
          return number.$mul();
        (output && C.LabelElement_methods).setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 2.204, 2) + " \u78c5");
      } else {
        t1 = type === "l";
        t1 = t1 || t1;
        ...
        if (t1) {
          ...
          if (typeof number !== "number")
            return number.$mul();
          t2.setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 0.4535, 2) + " \u516c\u65a4");
        } else
  ...
  (function inheritance() {
    ...
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.BaseElement, W.BodyElement, W.FormElement, W.InputElement, W.LabelElement, W.SelectElement, W.TableElement, W.TableRowElement, W.TableSectionElement, W.TemplateElement]);
...
//# sourceMappingURL=kglb_html.js.map
